...
nvme create-ns -s 0x9600000 -c 0x9600000 -f 0 -i 2 /dev/nvme1  #300 zones
nvme attach-ns /dev/nvme1 -c 0 -n 1
sleep 5
nvme format /dev/nvme1n1 -b 4096 -f
nvme create-ns -s 0x9600000 -c 0x9600000 -f 0 -i 2 /dev/nvme1  #300 zones
nvme attach-ns /dev/nvme1 -c 0 -n 2
sleep 5
nvme format /dev/nvme1n2 -b 4096 -f
...
nvme zone-mgmt /dev/nvme1n1 -a reset -s 0 -n 1 -c
nvme zone-mgmt /dev/nvme1n2 -a reset -s 0 -n 2 -c
...
nvme delete-ns /dev/nvme1 -n 0xffffffff
nvme create-ns -s 0x12C00000 -c 0x12c00000 -f 0 -i 2 /dev/nvme1  #600 zones
nvme attach-ns /dev/nvme1 -c 0 -n 1
sleep 5
nvme format /dev/nvme1n1 -b 4096 -f
echo "none" | tee /sys/block/nvme1n1/queue/scheduler
...
echo -e "none" | tee /sys/block/nvme1n1/queue/scheduler
...
nvme delete-ns /dev/nvme1 -n 0xffffffff
nvme create-ns -s 0x1200000 -c 0x1200000 -f 0 -csi 2 /dev/nvme1  #36 zones
nvme attach-ns /dev/nvme1 -c 0 -n 1
sleep 5
nvme format /dev/nvme1n1 -b 4096 -f
echo "none" | tee /sys/block/nvme1n1/queue/scheduler
...
nvme delete-ns /dev/nvme1 -n 0xffffffff
nvme create-ns -s 0x80000 -c 0x80000 -f 0 -csi 0 /dev/nvme1  
nvme attach-ns /dev/nvme1 -c 0 -n 1
nvme create-ns -s 0x1200000 -c 0x1200000 -f 0 -csi 2 /dev/nvme1  #36 zones
nvme attach-ns /dev/nvme1 -c 0 -n 2
sleep 5
...
sudo nvme create-ns -s 0x600000 -c 0x600000 -f 0 -csi 2 /dev/nvme1  #12 zones
sudo nvme attach-ns /dev/nvme1 -c 0 -n 1
sleep 5
sudo nvme format /dev/nvme1n1 -b 4096 -f
echo "mq-deadline" | tee /sys/block/nvme1n1/queue/scheduler
